...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Hvor vil du starte?"><p><span id="null">Hvor vil du starte?</span></p></div>')
    
    setTimeout(function(){
        $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Sidste placering"><p><span id="current-location">Sidste placering</span></p></div>');
